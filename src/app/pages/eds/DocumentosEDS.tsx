...
const documentTypes = [
  { name: "Registro de Ventas", icon: TrendingUp, color: "blue" },
  { name: "Inventario de Combustible", icon: Fuel, color: "orange" },
  { name: "Facturas de Compra", icon: FileText, color: "green" },
  { name: "Remisiones", icon: Package, color: "purple" },
  { name: "Reporte SICOM", icon: FileText, color: "red" },
  { name: "Control de Tanques", icon: Fuel, color: "teal" },
];
...
const mockDocuments: Document[] = [
  {
    ...
    numero: "VTA-2024-001",
    fecha: "2024-03-14",
    descripcion: "Ventas diarias gasolina corriente",
    cantidad: 15000,
    valor: 45000000,
    estado: "Registrado",
  },
  {
    id: "2",
    type: "Inventario de Combustible",
    numero: "INV-2024-045",
    fecha: "2024-03-13",
  ...
  },
  {
    id: "3",
    type: "Reporte SICOM",
    numero: "SICOM-2024-03",
    fecha: "2024-03-12",
    descripcion: "Reporte mensual SICOM",
    cantidad: 0,
    valor: 0,
    estado: "Pendiente",
  },
...
export default function DocumentosEDS() {
    ...
    <div className="p-6 space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-1">
          Gestión de documentos de estaciones de servicio
        </p>
      </div>
              ...
              {filteredDocuments.map((doc) => (
                <tr key={doc.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-gray-900">
                    {doc.cantidad > 0 ? doc.cantidad.toLocaleString("es-CO") : "-"}
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap font-medium text-gray-900">
                    {doc.valor > 0 ? `$${doc.valor.toLocaleString("es-CO")}` : "-"}
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span
          ...
          <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <input
                  type="text"
                  defaultValue={selectedDocument.descripcion}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    type="number"
                    defaultValue={selectedDocument.cantidad}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                <div>
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-gray-200">
                ...
                <button className="px-6 py-2 bg-gradient-to-r from-orange-600 to-orange-700 text-white rounded-lg hover:from-orange-700 hover:to-orange-800 shadow-md transition-all">
